...
def load_snr_and_injection_data_own(snr_file, params_file, idx_start=0, idx_end=None):
    with h5py.File(snr_file, 'r') as snr_f, h5py.File(params_file, 'r') as params_f:
        ...
        H1_merger_time = params_f['H_time'][()]
        L1_merger_time = params_f['L_time'][()]
        V1_merger_time = params_f['V_time'][()]

    return h1_real, l1_real, v1_real, h1_imag, l1_imag, v1_imag, injection_snr, ra, dec, mass_1, mass_2, spin_1, spin_2, H1_merger_time, L1_merger_time, V1_merger_time
...
logging.info("Loading SNR and injection data for training...")
for i in range(9):
    h1_real_1, l1_real_1, v1_real_1, h1_imag_1, l1_imag_1, v1_imag_1, injection_snr_1, ra_1, dec_1,mass_1_1, mass_1_2, spin_1_1, spin_1_2, H_merger_time_1, L_merger_time_1, V_merger_time_1 = load_snr_and_injection_data_own(
    ...
    H_merger_time = concatenate([H_merger_time, H_merger_time_1], axis=0)
    L_merger_time = concatenate([L_merger_time, L_merger_time_1], axis=0)
    V_merger_time = concatenate([V_merger_time, V_merger_time_1], axis=0)
...
def compute_metrics_at_merger(h1_real, l1_real, v1_real, h1_imag, l1_imag, v1_imag, H_time, L_time, V_time):
    ...
    time_diff_h1_l1 = H_time - L_time
    time_diff_h1_v1 = H_time - V_time
    time_diff_l1_v1 = L_time - V_time
