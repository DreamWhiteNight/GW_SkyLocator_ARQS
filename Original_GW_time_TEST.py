...
h1_real_1, l1_real_1, v1_real_1, h1_imag_1, l1_imag_1, v1_imag_1, injection_snr_1, ra_1, dec_1,mass_1_1, mass_1_2, spin_1_1, spin_1_2 = load_snr_and_injection_data(
    ...
    '/home/slash/O3_noise_GW170817_BBH_3_det_parameters_1.hdf',idx_end = None)
...
h1_real_2, l1_real_2, v1_real_2, h1_imag_2, l1_imag_2, v1_imag_2, injection_snr_2, ra_2, dec_2, mass_2_1, mass_2_2, spin_2_1, spin_2_2 = load_snr_and_injection_data(
    ...
    '/home/slash/O3_noise_GW170817_BBH_3_det_parameters_2.hdf',idx_end = None)
...
#    '/home/slash/bank_3/O3_noise_GW170817_BBH_3_det_parameters_3.hdf')
...
h1_real_4, l1_real_4, v1_real_4, h1_imag_4, l1_imag_4, v1_imag_4, injection_snr_4, ra_4, dec_4, mass_4_1, mass_4_2, spin_4_1, spin_4_2 = load_snr_and_injection_data(
    ...
    '/home/slash/O3_noise_GW170817_BBH_3_det_parameters_4.hdf',idx_end = None)

h1_real_5, l1_real_5, v1_real_5, h1_imag_5, l1_imag_5, v1_imag_5, injection_snr_5, ra_5, dec_5,mass_5_1, mass_5_2, spin_5_1, spin_5_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_18.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_18_parameters.hdf',idx_end = None)
...
h1_real_6, l1_real_6, v1_real_6, h1_imag_6, l1_imag_6, v1_imag_6, injection_snr_6, ra_6, dec_6,mass_6_1, mass_6_2, spin_6_1, spin_6_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_22.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_22_parameters.hdf',idx_end = None)
...
h1_real_7, l1_real_7, v1_real_7, h1_imag_7, l1_imag_7, v1_imag_7, injection_snr_7, ra_7, dec_7,mass_7_1, mass_7_2, spin_7_1, spin_7_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_23.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_23_parameters.hdf',idx_end = None)
...
h1_real_8, l1_real_8, v1_real_8, h1_imag_8, l1_imag_8, v1_imag_8, injection_snr_8, ra_8, dec_8,mass_8_1, mass_8_2, spin_8_1, spin_8_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_19.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_19_parameters.hdf',idx_end = None)
h1_real_9, l1_real_9, v1_real_9, h1_imag_9, l1_imag_9, v1_imag_9, injection_snr_9, ra_9, dec_9,mass_9_1, mass_9_2, spin_9_1, spin_9_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_21.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_21_parameters.hdf',idx_end = None)
h1_real_10, l1_real_10, v1_real_10, h1_imag_10, l1_imag_10, v1_imag_10, injection_snr_10, ra_10, dec_10,mass_10_1, mass_10_2, spin_10_1, spin_10_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_11.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_11_parameters.hdf',idx_end = None)
h1_real_11, l1_real_11, v1_real_11, h1_imag_11, l1_imag_11, v1_imag_11, injection_snr_11, ra_11, dec_11,mass_11_1, mass_11_2, spin_11_1, spin_11_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_14.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_14_parameters.hdf',idx_end = None)
h1_real_12, l1_real_12, v1_real_12, h1_imag_12, l1_imag_12, v1_imag_12, injection_snr_12, ra_12, dec_12,mass_12_1, mass_12_2, spin_12_1, spin_12_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_16.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_16_parameters.hdf',idx_end = None)
h1_real_13, l1_real_13, v1_real_13, h1_imag_13, l1_imag_13, v1_imag_13, injection_snr_13, ra_13, dec_13,mass_13_1, mass_13_2, spin_13_1, spin_13_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_20.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_20_parameters.hdf',idx_end = None)
h1_real_14, l1_real_14, v1_real_14, h1_imag_14, l1_imag_14, v1_imag_14, injection_snr_14, ra_14, dec_14,mass_14_1, mass_14_2, spin_14_1, spin_14_2 = load_snr_and_injection_data_own(
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_17.hdf',
    '/mnt/data/slash/Inj_Data/Inj_Data_zoo_17_parameters.hdf',idx_end = None)
...
injection_snr = np.concatenate([injection_snr_1, injection_snr_2,injection_snr_4, injection_snr_5,injection_snr_6,injection_snr_7,injection_snr_8,injection_snr_9,injection_snr_10,injection_snr_11,injection_snr_12,injection_snr_13,injection_snr_14], axis=0)

# Apply the filter: Only keep samples with Injection SNR > 12
logging.info("Filtering samples with Injection SNR > 15...")
snr_filter = np.logical_and(injection_snr > 10,injection_snr <60)
...
v1_imag = v1_imag[snr_filter]
'''
mass_1 = np.concatenate([mass_1_1, mass_2_1  ,mass_4_1,mass_5_1,mass_6_1,mass_7_1,mass_8_1,mass_9_1,mass_10_1,mass_11_1,mass_12_1,mass_13_1,mass_14_1], axis=0)
mass_2 = np.concatenate([mass_1_2, mass_2_2  ,mass_4_2,mass_5_2,mass_6_2,mass_7_2,mass_8_2,mass_9_2,mass_10_2,mass_11_2,mass_12_2,mass_13_2,mass_14_2], axis=0)
spin_1 = np.concatenate([spin_1_1, spin_2_1 ,spin_4_1,spin_5_1,spin_6_1,spin_7_1,spin_8_1,spin_9_1,spin_10_1,spin_11_1,spin_12_1,spin_13_1,spin_14_1], axis=0)
spin_2 = np.concatenate([spin_1_2, spin_2_2 ,spin_4_2,spin_5_2,spin_6_2,spin_7_2,spin_8_2,spin_9_2,spin_10_2,spin_11_2,spin_12_2,spin_13_2,spin_14_2], axis=0)
...
def compute_metrics_at_merger(h1_real, l1_real, v1_real, h1_imag, l1_imag, v1_imag):
    ...
    time_diffs = np.stack([time_diff_h1_l1/2048*1000000, time_diff_h1_v1/2048*1000000, time_diff_l1_v1/2048*1000000], axis=1)
    # Compute amplitude ratios at the merger
    amp_ratios = np.stack([abs((h1_imag_merger + h1_real_merger*(1j))) / abs((l1_real_merger + l1_real_merger*(1j))), 
                           abs((h1_real_merger + h1_real_merger*(1j))) / abs((v1_real_merger + v1_real_merger*(1j))), 
                           abs((l1_real_merger + l1_real_merger*(1j))) / abs((v1_real_merger + v1_real_merger*(1j)))], axis=1)
    ...
    merger_idx_h1 = merger_idx_h1-1
    merger_idx_l1 = merger_idx_l1-1
    merger_idx_v1 = merger_idx_v1-1
    h1_real_merger = h1_real[idx_range, merger_idx_h1]
    l1_real_merger = l1_real[idx_range, merger_idx_l1]
    v1_real_merger = v1_real[idx_range, merger_idx_v1]
    ...
    amp_ratios_m = np.stack([(h1_real_merger) / (l1_real_merger),
    ...
    phase_h1_n = np.angle(h1_real_merger+h1_imag_merger*(1j))
    phase_l1_n = np.angle(l1_real_merger+l1_imag_merger*(1j))
    phase_v1_n = np.angle(v1_real_merger+v1_imag_merger*(1j))
    amp_ratios_n = np.stack([(h1_real_merger) / (l1_real_merger),
                           (h1_real_merger) / (v1_real_merger),
                           (l1_real_merger) / (v1_real_merger)], axis=1)
    ...
    phase_h1_o = np.angle(h1_real_merger+h1_imag_merger*(1j))
    phase_l1_o = np.angle(l1_real_merger+l1_imag_merger*(1j))
    phase_v1_o = np.angle(v1_real_merger+v1_imag_merger*(1j))
    amp_ratios_o = np.stack([(h1_real_merger) / (l1_real_merger),
                           (h1_real_merger) / (v1_real_merger),
                           (l1_real_merger) / (v1_real_merger)], axis=1)
    ...
    phase_h1_p = np.angle(h1_real_merger+h1_imag_merger*(1j))
    phase_l1_p = np.angle(l1_real_merger+l1_imag_merger*(1j))
    phase_v1_p = np.angle(v1_real_merger+v1_imag_merger*(1j))
    amp_ratios_p = np.stack([(h1_real_merger) / (l1_real_merger),
                           (h1_real_merger) / (v1_real_merger),
                           (l1_real_merger) / (v1_real_merger)], axis=1)
    ...
    phase_h1_q = np.angle(h1_real_merger+h1_imag_merger*(1j))
    phase_l1_q = np.angle(l1_real_merger+l1_imag_merger*(1j))
    phase_v1_q = np.angle(v1_real_merger+v1_imag_merger*(1j))
    amp_ratios_q = np.stack([(h1_real_merger) / (l1_real_merger),
                           (h1_real_merger) / (v1_real_merger),
                           (l1_real_merger) / (v1_real_merger)], axis=1)
    ...
    phase_h1_r = np.angle(h1_real_merger+h1_imag_merger*(1j))
    phase_l1_r = np.angle(l1_real_merger+l1_imag_merger*(1j))
    phase_v1_r = np.angle(v1_real_merger+v1_imag_merger*(1j))
    amp_ratios_r = np.stack([(h1_real_merger) / (l1_real_merger),
                           (h1_real_merger) / (v1_real_merger),
                           (l1_real_merger) / (v1_real_merger)], axis=1)
    merger_idx_h1 = merger_idx_h1-1
    merger_idx_l1 = merger_idx_l1-1
    ...
    phase_h1_s = np.angle(h1_real_merger+h1_imag_merger*(1j))
    phase_l1_s = np.angle(l1_real_merger+l1_imag_merger*(1j))
    phase_v1_s = np.angle(v1_real_merger+v1_imag_merger*(1j))
    amp_ratios_s = np.stack([(h1_real_merger) / (l1_real_merger),
                           (h1_real_merger) / (v1_real_merger),
                           (l1_real_merger) / (v1_real_merger)], axis=1)
    merger_idx_h1 = merger_idx_h1-1
    merger_idx_l1 = merger_idx_l1-1
    ...
    phase_h1_t = np.angle(h1_real_merger+h1_imag_merger*(1j))
    phase_l1_t = np.angle(l1_real_merger+l1_imag_merger*(1j))
    phase_v1_t = np.angle(v1_real_merger+v1_imag_merger*(1j))
    amp_ratios_t = np.stack([(h1_real_merger) / (l1_real_merger),
                           (h1_real_merger) / (v1_real_merger),
                           (l1_real_merger) / (v1_real_merger)], axis=1)
    merger_idx_h1 = merger_idx_h1-1
    merger_idx_l1 = merger_idx_l1-1
    ...
    phase_h1_u = np.angle(h1_real_merger+h1_imag_merger*(1j))
    phase_l1_u = np.angle(l1_real_merger+l1_imag_merger*(1j))
    phase_v1_u = np.angle(v1_real_merger+v1_imag_merger*(1j))
    amp_ratios_u = np.stack([(h1_real_merger) / (l1_real_merger),
                           (h1_real_merger) / (v1_real_merger),
                           (l1_real_merger) / (v1_real_merger)], axis=1)
    ...
    phase_lags_m = np.stack([phase_h1_m - phase_l1_m, phase_h1_m - phase_v1_m, phase_l1_m - phase_v1_m], axis=1)
    phase_lags_n = np.stack([phase_h1_n - phase_l1_n, phase_h1_n - phase_v1_n, phase_l1_n - phase_v1_n], axis=1)
    phase_lags_o = np.stack([phase_h1_o - phase_l1_o, phase_h1_o - phase_v1_o, phase_l1_o - phase_v1_o], axis=1)
    phase_lags_p = np.stack([phase_h1_p - phase_l1_p, phase_h1_p - phase_v1_p, phase_l1_p - phase_v1_p], axis=1)
    phase_lags_q = np.stack([phase_h1_q - phase_l1_q, phase_h1_q - phase_v1_q, phase_l1_q - phase_v1_q], axis=1)
    phase_lags_r = np.stack([phase_h1_r - phase_l1_r, phase_h1_r - phase_v1_r, phase_l1_r - phase_v1_r], axis=1)
    # Combine all metrics into a single array
    phase_lags_s = np.stack([phase_h1_s - phase_l1_s, phase_h1_s - phase_v1_s, phase_l1_s - phase_v1_s], axis=1)
    phase_lags_t = np.stack([phase_h1_t - phase_l1_t, phase_h1_t - phase_v1_t, phase_l1_t - phase_v1_t], axis=1)
    phase_lags_u = np.stack([phase_h1_u - phase_l1_u, phase_h1_u - phase_v1_u, phase_l1_u - phase_v1_u], axis=1)
    omega_mn = (phase_lags_m - phase_lags_n) * 2048.0 * 5
    omega_no = (phase_lags_n - phase_lags_o) * 2048.0 * 5
    omega_op = (phase_lags_o - phase_lags_p) * 2048.0 * 5
    omega_pq = (phase_lags_p - phase_lags_q) * 2048.0 * 5

    combined_metrics = np.concatenate([time_diffs,amp_ratios,phase_lags,amp_ratios_m,phase_lags_m,amp_ratios_n,phase_lags_n,amp_ratios_o,phase_lags_o,amp_ratios_p,phase_lags_p,amp_ratios_q,phase_lags_q,amp_ratios_r,phase_lags_r,amp_ratios_s,phase_lags_s,amp_ratios_t,phase_lags_t,amp_ratios_u,phase_lags_u], axis=1)
...
class ResNet34Encoder(nn.Module):
    ...
    def forward(self,x, metrics):
        ...
        merged = torch.cat([metrics], dim=1)
...
encoder_output_dim = topk_metrics  # Fr3om ResNet and metrics MLP\t
...
for epoch in range(num_epochs):
    ...
    if val_epoch_loss < best_val_loss:
        ...
        torch.save({
            ...
            'val_loss': val_losses,
        }, 'best_model_Original_ResNet34_5_5_256_4_time_TEST.pth')
    else:
        epochs_no_improve += 1
